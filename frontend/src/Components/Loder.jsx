...
const Loader = () => {
  return (
    <div className="flex items-center justify-center min-h-screen w-full bg-transparent overflow-hidden relative bg-white">
      <div className="absolute z-10 flex items-center justify-center p-8">
        <svg
          width="100"
          height="100"
          viewBox="0 0 240 240"
