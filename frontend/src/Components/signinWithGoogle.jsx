    ...
    return (
      <>
        <div className="">
          ...
          >
            <svg
              className="lg:mr-[0.5vw] mr-[1.5vw]"
              width="23"
              height="22"
              viewBox="0 0 25 24"
              fill="none"
              ...
              <defs>
                <clipPath id="clip0_1413_81">
                  <rect
                    ...
                    height="23.9659"
                    fill="white"
                    transform="translate(0.675781 0.03125)"
                  />
                </clipPath>
              </defs>
            </svg>
